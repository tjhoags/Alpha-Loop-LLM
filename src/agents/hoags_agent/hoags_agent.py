...
from src.core.aca_engine import ACAEngine, get_aca_engine
...
class HoagsAgent(BaseAgent):
    ...
    def _handle_run_workflow(self, task: Dict[str, Any]) -> Dict[str, Any]:
        """Handler wrapper for run_daily_workflow."""
    ...
    def process(self, task: Dict[str, Any]) -> Dict[str, Any]:
        ...
        handler = self._handlers.get(task_type, self._general_reasoning)
        return handler(task)
...
# SINGLETON ACCESSOR
# =============================================================================
_hoags_instance: Optional[HoagsAgent] = None


def get_hoags() -> HoagsAgent:
    """Get the singleton HoagsAgent instance.

    Returns:
        The global HoagsAgent instance.
    """
    global _hoags_instance
    if _hoags_instance is None:
        _hoags_instance = HoagsAgent()
    return _hoags_instance
